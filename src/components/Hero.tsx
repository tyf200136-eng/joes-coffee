...
const FLOATING_CARDS: FloatingCard[] = [
  {
    name: "سينابون",
    image: "/images/menu/cinnamonRooll.jpg",
    position: "left",
    bottom: "30%",
    aspect: "aspect-[3/4]",
    movement: "-100%",
  ...
  {
    name: "تشيز كيك بالكرز",
    image: "/images/menu/CherryCheesecake.jpg",
    position: "right",
    bottom: "14%",
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="card w-28 sm:w-36 md:w-44 lg:w-48 p-1.5 sm:p-2 md:p-3 rounded-brand overflow-hidden"
      >
        <div className="relative">
          ...
          />
          <div className="card card--label absolute bottom-1 sm:bottom-1.5 md:bottom-2 inset-x-1 sm:inset-x-1.5 md:inset-x-2 rounded-[calc(var(--radius-brand)-0.75rem)] px-1.5 py-0.5 sm:px-2 sm:py-1">
  <h3
      ...
      <div className="flex flex-col gap-10 md:gap-12 w-full max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-end gap-5 text-right">
          ...
          >
            <a
              href="#contact"
              className="rounded-brand bg-foreground px-7 py-3.5 text-center text-sm font-medium transition-transform duration-300 ease-[cubic-bezier(0.65,0,0.35,1)] hover:scale-[1.03] hover:shadow-md"
        ...
        >
          ...
          >
            <source
              src="/images/menu/Animate_this_image_naturally.mp4"
              type="video/mp4"
            />
          </video>
        </motion.div>
